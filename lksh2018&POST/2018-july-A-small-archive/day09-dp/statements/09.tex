...
\def\ID{9}
\def\NAME{День \NO{\ID}, Динамика для топов}%
\def\WHERE{ЛКШ.2018.Июль, Берендеевы Поляны}%
\def\DATE{14 июля 2018}%
...
\probl{bridge}{A}{0.2 sec}{256 mb}      % 0.072 
\probl{sawmill}{B}{0.05 sec}{256 mb}     % 0.015
\probl{codes}{C}{1.5 sec}{256 mb}       % 0.612
\probl{lumberjack}{D}{0.2 sec}{256 mb}  % 0.049
\probl{piggybank}{E}{3.5 sec}{256 mb}   % 1.315

\Section{red}{Гробы}

\probl{convolution}{F}{1.5 sec}{256 mb} % 0.549
