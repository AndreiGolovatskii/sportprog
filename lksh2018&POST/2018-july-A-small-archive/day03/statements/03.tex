...
\def\ID{3}
\def\NAME{День \NO{\ID}, День боли}%
\def\WHERE{ЛКШ.2018.Июль, Берендеевы Поляны}%
\def\DATE{7 июня 2018}%
...
\probl{eulertour}{A}{0.6 sec}{256 mb}
\probl{sqrtrev}{B}{6 sec}{256 mb}
\probl{connect}{C}{1 sec}{256 mb}

\Section{red}{Гробы}

\probl{linkcut}{D}{0.8 sec}{256 mb}

\Section{red}{Для тестирования}

\probl{treap}{E}{2 sec}{256 mb}
