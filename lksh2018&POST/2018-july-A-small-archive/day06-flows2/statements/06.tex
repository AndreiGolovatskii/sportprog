...
\def\ID{6}
\def\NAME{День \NO{\ID}, Потоки-2}%
\def\WHERE{ЛКШ.2018.Июль, Берендеевы Поляны}%
\def\DATE{10 июля 2018}%
...
\probl{mincost}{A}{0.05 sec}{256 mb} % 0.007
\probl{brides}{B}{0.1 sec}{256 mb} % 0.023
\probl{assignment}{C}{1.5 sec}{256 mb} % 0.663
\probl{flow2}{D}{0.1 sec}{256 mb} % 0.038

\Section{red}{Гробы}

\probl{matching}{E}{3 sec}{256 mb} % 1.5
\probl{credit}{F}{0.1 sec}{256 mb} % 0.007
