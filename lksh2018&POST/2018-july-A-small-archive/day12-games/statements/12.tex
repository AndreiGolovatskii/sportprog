...
\def\ID{12}
\def\NAME{День \NO{\ID}, Игры}%
\def\WHERE{ЛКШ.2018.Июль, Берендеевы Поляны}%
\def\DATE{19 июля 2018}%
...
% Альфа-Дерево - 437 / 2.635
% Вас снова замяукали! - 23
% Жестокая задача - 24
% Вариация Нима - 4
% Игры на графе - 111
...
\probl{ab}{A}{1.5 sec}{256 mb}
\probl{labyrinth}{B}{0.1 sec}{256 mb}
\probl{cruel}{C}{0.1 sec}{256 mb}
\probl{varnim}{D}{0.1 sec}{256 mb}

\Section{red}{Гробы}

\probl{game}{E}{0.5 sec}{256 mb}
